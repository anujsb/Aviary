...
const Testimonials: React.FC = () => {
  return (
    <div
      id="Testimonials"
      className="h-auto my-20 flex flex-col items-center justify-center"
    >
      <div className="w-full lg:w-1/3 flex flex-col items-center justify-center text-center">
        ...
        {/* <div> */}
        <div className="mt-10">
          <div className="relative m-auto w-[1000px] overflow-hidden  before:absolute before:left-0 before:top-0 before:z-[2] before:h-full before:w-[100px] before:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] before:content-[''] after:absolute after:right-0 after:top-0 after:z-[2] after:h-full after:w-[100px] after:-scale-x-100 after:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] after:content-['']">
          ...
          <div className=" mt-5 relative m-auto w-[1000px] overflow-hidden before:absolute before:left-0 before:top-0 before:z-[2] before:h-full before:w-[100px] before:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] before:content-[''] after:absolute after:right-0 after:top-0 after:z-[2] after:h-full after:w-[100px] after:-scale-x-100 after:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] after:content-['']">
